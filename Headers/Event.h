...
public:
	...
	virtual vector<pair<unsigned int, unsigned int>> getResults() = 0;//gets results, if event does not have this parameter returns empty vector
	virtual void setResults(vector<pair<unsigned int, unsigned int>> results)=0;//sets results, if event does not have this parameter does nothing
